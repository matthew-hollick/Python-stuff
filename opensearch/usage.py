...
def write_detailed_csv(stats, filename, project):
    with open(filename, 'w', newline='') as csvfile:
        ...
        writer.writerow(['ENVIRONMENT', 'TEAM', 'NAME', 'YEAR', 'WEEK', 'INSTANCE',
                         'Total Size', 'Size of Primaries', 'Total Documents',
                         'Deleted Documents', 'Primaries', 'Replicas'])
        ...
        for index_name, index_stats in stats.items():
            ...
            if parsed:
                ...
                writer.writerow([
                    ...
                    index_stats['total']['docs']['count'] - index_stats['primaries']['docs']['count']
                ])
